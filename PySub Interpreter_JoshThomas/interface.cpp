...
void Interface::help(string arg) // Initiates help menu and checks help commands
{
	if (arg == "")
	{
		...
		while (line != "exit")
		{
			...
			if (line == "commands")
			{
				cout << "quit, help, read, show, clear, retV" << endl;
			}
			else if (line == "quit")
			{
			...
			{
				cout << "provides info on commands" << endl;
			}
			else if (line == "read")
			{
				cout << "clears stored lines, then reads and stores new program lines" << endl;
			}
			else if (line == "show")
			{
			...
			{
				cout << "Returns value of variable (must be assigned first)" << endl;
			}
			else if (line != "exit")
			{
	...
	else if (arg == "commands") //Checks Specific Help Request
	{
		cout << "quit, help, read, show, clear" << endl;
	}
	else if (arg == "quit")
	{
		cout << "quits the interpreter" << endl;
	...
	else cout << "Error: Not A Recognized Command. Try Again" << endl;
	command();
}
...
void Interface::print(string arg)
{
